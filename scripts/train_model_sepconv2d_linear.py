...
ofile = "../models/sep_conv2d_linear"+ofile
pltfile = "../plots/sep_conv2d_linear"+pltfile
model.save(ofile)
...
print("Model with Linear SeparableConv2D")
